...
epochs = 1000
batch_size = 2 
t = 0 # contador para correcion de sego 
...
for epoch in range(epochs):
    indecis = np.random.permutation((len(X_traind)))
    X_shuffled = X_traind[indecis]
    Y_shuffled = Y_traind[indecis]
    ...
    for i in range(0, len(X_traind), batch_size):
     ...
     # ---- TRAIN LOSS ----
        ...
        train_loss = compute_loss(Y_traind, Y_train_hat)
